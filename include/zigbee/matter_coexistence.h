 ...
 *
 * @param cb Callback table. The pointer must remain valid for the lifetime
 *           of the program; the module stores it internally.
 *
 * @retval 0       on success
 * @retval -EINVAL if @p cb or a required callback is NULL
 */
