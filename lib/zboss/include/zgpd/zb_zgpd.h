...
zb_zgpd_ch_options_t;
  ...
  void zgpd_send_success_cmd_delayed(zb_cb_param_t);
#endif
 ...
 */
void zb_zgpd_send_data_req(zb_bufid_t buf_ref, zb_bool_t use_secur);
 ...
 * @param buf_ref    [in]  Buffer with GPDF payload
 */
void zb_zgpd_send_maint_req(zb_bufid_t buf_ref);
