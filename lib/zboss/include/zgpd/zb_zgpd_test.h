...
void zgpd_channel_config_ind(zb_cb_param_t param);
void zgpd_channel_config_ind_test(zb_bufid_t param);
void zgpd_commiss_reply_ind(zb_cb_param_t param);
void zgpd_commiss_reply_ind_test(zb_bufid_t param);
