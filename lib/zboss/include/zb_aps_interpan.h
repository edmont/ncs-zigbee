 ...
 *
  ...
  */
void zb_intrp_data_frame_indication(zb_bufid_t param, zb_mac_mhr_t *mac_hdr, zb_uint8_t lqi, zb_int8_t rssi);
#endif /* ZB_ENABLE_INTER_PAN_EXCHANGE */
...
/** @brief Fill INTRP-DATA.confirm parameters.
  ...
  */
void zb_intrp_data_frame_confirm(zb_cb_param_t cb_param);
...
typedef struct zb_aps_inter_pan_mchan_func_selector_s {
  zb_ret_t (* put_aps_packet_to_queue)(zb_bufid_t param);
  zb_ret_t (* put_nwk_packet_to_queue)(zb_bufid_t param);
