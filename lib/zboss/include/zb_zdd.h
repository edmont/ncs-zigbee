...
#define ZIGBEE_DIRECT_DEFAULT_ADV_INTERVAL         244                                     /**< The advertising interval (in units of 0.625 ms; this value corresponds to 152.5 ms). */
...
#define ZIGBEE_DIRECT_DEFAULT_MIN_CONN_INTERVAL    6                                       /**< Minimum acceptable connection interval (6 * 1.25 = 7.5 milliseconds). */
#define ZIGBEE_DIRECT_DEFAULT_MAX_CONN_INTERVAL    80                                      /**< Maximum acceptable connection interval (80 * 1.25 = 100 milliseconds). */
