...
void zb_mcps_purge_indirect_queue_request_macsplit(zb_cb_param_t param);
void zb_macsplit_transport_boot_indication_call_timeout(zb_cb_param_t param);
void macsplit_indicate_boot(void);
zb_bool_t zb_handle_boot_indication_call(zb_bufid_t param);
void zb_mlme_dev_send_mac_tx_power(zb_cb_param_t param);
void zb_macsplit_transport_handle_device_boot_call(zb_bufid_t param);
void zb_macsplit_get_device_version_request(zb_cb_param_t param);
void zb_macsplit_get_device_version_confirm(zb_cb_param_t param);
void zb_macsplit_send_device_stack_information(zb_cb_param_t param);
void zb_mac_cancel_scan_macsplit(zb_cb_param_t param);
 ...
 * @param param unused
 */
void zb_macsplit_host_try_send_dev_boot_sig_and_skip_startup_sig(zb_cb_param_t param);
...
zb_bufid_t zb_macsplit_host_tx_data_hook(zb_bufid_t param, zb_bool_t *free_buf);
zb_bufid_t zb_macsplit_device_tx_data_hook(zb_bufid_t param, zb_bool_t *free_buf);
...
void zb_macsplit_transport_confirm_timeout(zb_cb_param_t param);
