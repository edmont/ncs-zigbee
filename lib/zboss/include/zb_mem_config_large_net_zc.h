 ...
 * DSR.
 */
/*  PURPOSE: The memory configuration for large networks for ZC role */
#ifndef ZB_MEM_CONFIG_LARGE_NET_ZC_H
#define ZB_MEM_CONFIG_LARGE_NET_ZC_H 1
...
#endif /* ZB_MEM_CONFIG_LARGE_NET_ZC_H */
