...
*/
typedef void (*zb_ncp_custom_response_cb_t)(zb_cb_param_t param);
 ...
 */
typedef void (*zb_ncp_custom_indication_cb_t)(zb_cb_param_t param);
 ...
 */
zb_uint8_t ncp_host_custom_request(zb_bufid_t param, zb_ncp_custom_response_cb_t cb);
